...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Country c =  Country.countryWithHighestCH4InYear(countries, 2000);
        //System.out.println(c.getName());
        c = Country.countryWithHighestChangeInEmissions(countries, 1988, 2012);
        //System.out.println(c.getName());
        Sector s = Sector.sectorWithBiggestChangeInEmissions(sectors, 1988, 2012);
